...
public interface UserMapper {
    UserDto toUserOutput(User value);
    UserRoleDto toUserRoleDto(UserRole value);
    UserRole toUserRole(UserRoleDto value);
    UserLanguageDto toUserLanguageDto(UserLanguage value);
    UserLanguage toUserLanguage(UserLanguageDto value);
}

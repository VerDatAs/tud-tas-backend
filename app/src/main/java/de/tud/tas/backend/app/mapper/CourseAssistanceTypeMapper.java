...
public interface CourseAssistanceTypeMapper {
    CourseAssistanceType toCourseAssistanceType(CourseAssistanceTypeDto value);
    CourseAssistanceTypeDto toCourseAssistanceTypeDto(CourseAssistanceType value);
    StatementProcessingRequestSupportedAssistanceTypesInner toSupportedAssistanceTypesInner(CourseAssistanceType value);
}
